function Terms() {
  return (
    <div className="termsPage">
      <p>
        <strong>
          <span style={{ fontSize: "22px;" }}>TERMS OF SERVICE</span>
        </strong>
      </p>
      <p></p>
      <p></p>
      ...
      <p></p>
      <p>
        This website is operated by Guber. Throughout the site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and
        &ldquo;our&rdquo; refer to Guber. Guber offers this website, including all information, tools, and services
      ...
      <p></p>
      <p>
        By visiting our site and/ or purchasing something from us, you engage in our &ldquo;Service&rdquo; and agree to
        ...
        of Service apply to all users of the site, including without limitation users who are br /owsers, vendors,
      ...
      <p>
        ...
        involve (a) transmissions over various networks; and (b) changes to conform and adapt to the technical
        requirements of connecting networks or devices. Credit card information is always encrypted during transfer over
        networks.
      </p>
      <p></p>
      <p>
      ...
      <p></p>
      <p>
        <strong>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATI</strong>ON
      </p>
      <p></p>
      <p>
      ...
      <p>
        ...
        available&rdquo; without any warranties, representations or conditions of any kind and without any endorsement.
      ...
      <p>
        In no case shall Guber, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers,
      ...
      <p></p>
      <p>
        You agree to indemnify, defend and hold harmless Guber and our parent, subsidiaries, affiliates, partners,
        officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and
        employees, harmless from any claim or demand, including reasonable attorneys&rsquo; fees, made by any
        third-party due to or arising out of your br /each of these Terms of Service or the documents they incorporate
      ...
      <p>
        ...
        construed in accordance with the laws of 2665 Erin Centre Blvd, Mississauga, ON, L5M5H6, Canada.
      </p>
      <p></p>
      <p>
      ...
      <p></p>
      <p>Questions about the Terms of Service should be sent to us at siddharthnema04@gmail.com.</p>
    </div>
  );
}
